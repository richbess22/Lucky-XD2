...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "lucky~PAd0RY4K#KweJ38XJqOl5gb7yl3xDQk0_0DaQmzEJofzjRRUoz98",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*Just seen ur status save namba angu 😆*",
...
OWNER_NAME: process.env.OWNER_NAME || "SILATRIX",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*© Powered By silatrix*",
// add bot owner name    
